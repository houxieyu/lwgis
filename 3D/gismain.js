...
define(['3D/renderFactory', "esri/Map","esri/views/MapView",'esri/Basemap',"esri/config","esri/layers/GraphicsLayer",
    ...
    function addQXBaseLayer(){
        if(findQXBaseLayer()==null)
        {
            var baselayer = new MapImageLayer({
                url: "http://124.133.27.90:6080/arcgis/rest/services/lwbj/MapServer/",
                opacity:0.8,
                id:'qxbase'
            });
/*                new MapImageLayer({
            url: "http://124.133.27.90:6080/arcgis/rest/services/JINING/JININGmap/MapServer"
        });*/
    ...
    function addSpatialLayer(){
        spatiallayer = new FeatureLayer({
            url: "http://124.133.27.90:6080/arcgis/rest/services/lwbj/MapServer/9",
            opacity:0,
            id:'spatiallayer',
...
//                [-93.94, 29.89,heigh]
 /*                 [ptstart.longitude, ptstart.latitude,ptstart.z+100],
    ...
    var urlpre = 'http://124.133.27.90:6080/arcgis/rest/services/lwbj/MapServer/';
    ...
    function spatialQuery(){
        var queryTask = new QueryTask({
            url: "http://124.133.27.90:6080/arcgis/rest/services/lwbj/MapServer/9"  // URL of a feature layer representing U.S. cities
        });
